...
| 产品 | 体验地址 | API 文档 | 默认账号 |
|------|---------|---------|---------|
| **Admin** | [https://demo.admin.gowind.cloud](https://demo.admin.gowind.cloud) | [Swagger](https://api.demo.admin.gowind.cloud/docs/) | admin / admin |
| **CMS** | 敬请期待 | - | - |
| **IM** | 敬请期待 | - | - |
| **UBA** | 敬请期待 | - | - |
...
| **MySQL/PostgreSQL** | 5.7+ / 12+ | 数据库 |
| **Redis** | 6.0+ | 缓存和消息队列（可选） |
...
# 安装 Go 相关工具
go install github.com/cosmtrek/air@latest  # 热加载工具
go install github.com/buf-build/buf/cmd/buf@latest  # Protocol Buffer 工具
```
